...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN', '5511455979:AAER7Q-9T65eycGqVllQi2biYC8KZxHnPJ8'))
    ...
    OWNER_ID = set(int(x) for x in os.environ.get("OWNER_ID", "1529044460").split())  
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '43.205.126.89:8080')) if not ON_HEROKU or getenv('FQDN', '43.205.126.89:8080') else APP_NAME+'.herokuapp.com'
